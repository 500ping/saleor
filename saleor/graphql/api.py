...
from stock_notification.graphql.schema import TransferRequestMutations, TransferRequestQueries
from preorder.graphql.schema import PreOrderQueries, PreOrderMutations
